...
const nivelAct = document.getElementById('nivel');
const puntajeAct = document.getElementById('puntaje');
...
class Juego {
    ...
    elegirColor(event) {
        ...
        if (numeroColor === this.secuencia[this.subnivel]) {
            ...
            puntajeAct.innerHTML = this.puntaje;
    ...
    perdedor() {
        swal('Perdiste', 'Fallaste, intentalo nuevamente!!', 'error')
            .then(() => {
                this.eliminarEventosClick();
                this.inicializar();
            });
